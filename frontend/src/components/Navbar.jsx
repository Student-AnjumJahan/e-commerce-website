                    ...
                    <nav className="flex flex-wrap items-center gap-4">
                        ...
                        {user && (
							...
							ease-in-out">
                                ...
                                {cart.length > 0 && (<span className="absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-2 py-0.5 text-xs group-hover:bg-emerald-400 transform duration-300 ease-in-out">
                                    {cart.length}
                                </span>
                                )}
                            </Link>
